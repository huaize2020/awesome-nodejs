...
- [flamebearer](https://github.com/mapbox/flamebearer) - Blazing fast flame graph tool for V8 and Node 🔥. ![](https://img.shields.io/github/stars/mapbox/flamebearer.svg?style=social&label=Star) 
...
- [pidusage](https://github.com/soyuka/pidusage) - Cross-platform process cpu % and memory usage of a PID. ![](https://img.shields.io/github/stars/soyuka/pidusage.svg?style=social&label=Star)
...
- ODM / ORM
  ...
  - [Neuledge](https://github.com/neuledge/engine-js) - Universal language for databases that provides state-of-the-art tools for data modeling, business logic representation, and schema validation. ![](https://img.shields.io/github/stars/neuledge/engine-js.svg?style=social&label=Star)
...
- Coverage
  ...
  - [c8](https://github.com/bcoe/c8) - output coverage reports using Node.js' built in coverage. ![](https://img.shields.io/github/stars/bcoe/c8.svg?style=social&label=Star)
...
- Request Client
  ...
  - [isomorphic-fetch](https://github.com/matthew-andrews/isomorphic-fetch) - Isomorphic WHATWG Fetch API, for Node & Browserify. ![](https://img.shields.io/github/stars/matthew-andrews/isomorphic-fetch.svg?style=social&label=Star)
...
- [node-consul](https://github.com/silas/node-consul) - Consul client.  ![](https://img.shields.io/github/stars/silas/node-consul.svg?style=social&label=Star)
...
- Other
  ...
  - [ts-morph](https://github.com/dsherret/ts-morph) - TypeScript Compiler API wrapper. Provides an easier way to programmatically navigate and manipulate TypeScript and JavaScript code. ![](https://img.shields.io/github/stars/dsherret/ts-morph.svg?style=social&label=Star)
...
- [opencv](https://github.com/peterbraden/node-opencv) - OpenCV is the defacto computer vision library - by interfacing with it natively in node, we get powerful real time vision in js. ![](https://img.shields.io/github/stars/peterbraden/node-opencv.svg?style=social&label=Star)
